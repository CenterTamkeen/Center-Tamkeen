...
export default function HowItWorksPage() {
  return (
    <StaticPageShell
      ...
      intro="تجربة تمكين مبنية على خطوات قليلة: إنشاء حساب، اختيار مدرس أو كورس، إرسال طلب الاشتراك، ثم متابعة المحتوى من لوحة الطالب."
    >
      ...
      <StaticSection title="٣. إرسال طلب الاشتراك">
        <p>بعد إرسال الطلب، تقوم الإدارة بمراجعته وتفعيل الوصول عند اكتماله.</p>
      </StaticSection>
